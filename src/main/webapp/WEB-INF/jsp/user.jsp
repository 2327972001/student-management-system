            ...
            <form action="/user/show" method="post">
                <div class="custom-control-inline mr-0">
                    <select class="form-control" name="type">
                        <option selected>请选择您要查询的类型</option>
                        <option value="0">查序号</option>
                        <option value="1">查姓名</option>
                        <option value="2">查用户名</option>
                        <option value="3">查性别</option>
                        <option value="4">查班级</option>
                    </select>
                </div>
                <div class="custom-control-inline mr-0">
